...
export default function ProfilePage() {
  ...
  async function handleVerificationSubmit() {
    if (!userId || !verificationFile) {
      toast.error(
        "Please choose your verification document."
      );
      return;
    }
    ...
    try {
      const extension =
        verificationFile.name.split(".").pop() ||
        "jpg";
  ...
  function getRoleLabel(role: Role) {
    ...
    if (role === "property_owner")
      return "Landlord / Property Owner";
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <House
                  size={20}
                  className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#C9A227]"
                />
                ...
                <select
                  ...
                  className="w-full appearance-none rounded-2xl border border-slate-200 bg-white py-4 pl-12 pr-10 font-semibold text-[#1B1B1B] outline-none transition focus:border-[#C9A227] focus:ring-2 focus:ring-[#C9A227]/10"
                >
                  <option value="home_seeker">
                    Home Seeker
                  </option>
              ...
              <p className="mt-2 text-sm text-slate-500">
                You can change your account type whenever your situation changes.
              </p>
            </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-slate-600">
                Verify your identity to help other HomeLinker users know that your account is genuine.
              </p>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-emerald-700">
                    Other users can now see that your HomeLinker profile has been verified.
                  </p>
                </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-yellow-700">
                    Your verification documents have been submitted. Please wait while HomeLinker reviews them.
                  </p>
                </div>
              ...
              <div className="mt-6 rounded-2xl border-2 border-dashed border-[#E8D9A8] bg-[#FFFDF8] p-6">
                ...
                <div className="text-center">
                  ...
                  <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-500">
                    Upload a clear photo of an accepted identity document. Your document is stored privately and only used for verification.
                  </p>
